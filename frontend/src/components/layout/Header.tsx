...
export default function Header() {
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "max-w-6xl mx-auto px-6 transition-all duration-300 rounded-full",
                    scrolled ? "bg-white/80 backdrop-blur-md shadow-lg shadow-orange-500/5 mx-4 border border-white/50" : ""
                )}
            >
