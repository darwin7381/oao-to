...
import { Copy, Check, Terminal, BookOpen, Shield, Zap, Globe, Code as CodeIcon } from 'lucide-react';
...
export default function ApiPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['intro', 'authentication', 'endpoints', 'rate-limits', 'examples'];
  ...
  return (
    <div className="min-h-screen relative bg-background font-nunito">
      {/* Background Blobs */}
          ...
          <div className="lg:grid lg:grid-cols-[224px_1fr] lg:gap-8">
            ...
            <aside className="hidden lg:block">
              <div className="sticky top-24 space-y-6 max-h-[calc(100vh-8rem)] overflow-y-auto">
                ...
                <div className="p-5 bg-gradient-to-br from-orange-400 to-pink-500 text-white rounded-2xl shadow-lg">
                  <h4 className="font-bold mb-2 text-sm">Need API Keys?</h4>
                  <p className="text-xs text-white/90 mb-4">
                    Create and manage your API keys in the dashboard.
                  </p>
                  <Link to="/dashboard/api-keys">
                    <Button size="sm" variant="secondary" className="w-full text-xs h-8 bg-white text-orange-500 hover:bg-white/90 font-bold">
                      Go to Dashboard
                    </Button>
                  </Link>
                </div>
              ...
              <section id="intro" className="mb-16">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 font-bold mt-1">Version 1.0.0</p>
                  </div>
                </div>

                <p className="text-xl text-gray-600 leading-relaxed mb-8 font-medium">
                  Build powerful integrations with the OAO.TO API. Programmatically create short links, 
                  manage your branded URLs, and access real-time analytics.
                </p>
  ...
  -H "Authorization: Bearer YOUR_API_KEY"`}
              ...
              <section id="examples" className="mb-16 scroll-mt-24">
                <h2 className="text-2xl font-black text-gray-900 mb-6">Code Examples</h2>

                <div className="space-y-6">
                  <Card className="border-2">
                    <div className="border-b border-gray-100 bg-gray-50/50 p-6">
                      <h3 className="text-xl font-black text-gray-900">JavaScript / Node.js</h3>
                    </div>
                    <CardContent className="p-6">
                      <CodeBlock
                        language="javascript"
                        code={`const response = await fetch('https://api.oao.to/api/links', {
  method: 'POST',
  headers: {
...
console.log(data.shortUrl); // https://oao.to/my-link`}
                      />
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2">
                    <div className="border-b border-gray-100 bg-gray-50/50 p-6">
                      <h3 className="text-xl font-black text-gray-900">Python</h3>
                    </div>
                    <CardContent className="p-6">
                      <CodeBlock
                        language="python"
...
data = response.json()
print(data['shortUrl'])  # https://oao.to/my-link`}
                      />
                    </CardContent>
                  </Card>
                </div>
    ...
    <div className="rounded-xl overflow-hidden bg-[#1e1e1e] shadow-lg border border-gray-800">
      <div className="flex items-center justify-between px-4 py-3 bg-[#252526] border-b border-gray-800">
        ...
        <div className="flex items-center gap-3">
          <Badge variant="secondary" className="bg-gray-700 text-gray-300 border-0 h-5 text-[10px] uppercase font-bold">
            {language}
          </Badge>
          <button
            onClick={handleCopy}
