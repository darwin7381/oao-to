...
-- ==========================================
-- 7. 优化 Credits 表（删除冗余字段）
-- ==========================================
-- 背景：0003 添加了 subscription_balance 和 monthly_quota
-- 问题：subscription_balance 从未使用，monthly_quota 应从 plans 动态获取
-- 解决：删除这两个字段，改为动态 JOIN
...
-- 复制数据（排除 subscription_balance 和 monthly_quota）
